...
static int handle_event(void *ctx, void *data, size_t data_sz)
{
    ...
    /* Convert IPv4 addresses to human-readable strings */
 ...
 * It updates cumulative statistics (shared with IPv4) and writes a CSV
 * line to the appropriate per-user log file.
 *
 * Returns: 0 to continue processing events
 */
static int handle_event_v6(void *ctx, void *data, size_t data_sz)
{
    ...
    /* Convert IPv6 addresses to human-readable strings */
    ...
    if (f) {
         ...
         *
         * Example:
         *   out,80,2001:db8::1,2607:f8b0::200e,1732985432.123456789,0,80
         */
        fprintf(f, "%s,%u,%s,%s,%ld.%09ld,%llu,%llu\n",
                e->direction ? "out" : "in",
                e->bytes,
